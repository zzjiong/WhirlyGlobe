...
- (void)globeViewController:(WhirlyGlobeViewController *)viewC didStopMoving:(MaplyCoordinate *)corners userMotion:(bool)userMotion{
    ...
    [viewC changeVector:self.maplyVectorOject desc:@{kMaplyVecWidth :@(width),kMaplyColor : [UIColor colorWithWhite:color/255.0 alpha:1],kMaplyDrawPriority:@(kMaplyVectorDrawPriorityDefault+100)}];
    return;
    //The first case
